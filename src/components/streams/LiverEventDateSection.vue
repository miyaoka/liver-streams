...
<template>
  <section class="relative pb-12 pt-0" data-id="date-section" :data-time="`${dateSection.time}`">
    ...
    <header class="pointer-events-none sticky top-0 z-20 mb-8">
      <div class="absolute bottom-full h-4 w-full bg-gradient-to-t from-black/30" />
      <div class="flex w-full flex-col items-center justify-center bg-black/30 py-4">
      ...
      <div class="absolute top-full h-20 w-full bg-gradient-to-b from-black/30" />
    </header>
