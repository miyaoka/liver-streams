...
<template>
  <section class="relative pb-12 pt-0" data-id="date-section" :data-time="`${dateSection.time}`">
    ...
    <header class="pointer-events-none sticky top-0 z-20 mb-8">
      <div class="absolute bottom-full h-8 w-full bg-gradient-to-t from-black/50" />
      <div class="flex w-full flex-col items-center justify-center bg-black/50 py-2">
      ...
      <div class="absolute top-full h-8 w-full bg-gradient-to-b from-black/50" />
    </header>
